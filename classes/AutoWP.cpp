...
_LIT8(KHost, "open.movilforum.com");
_LIT8(KConnection, "Keep-Alive");
_LIT8(KEncoding, "gzip, deflate");

// url
_LIT8(KUrl, "http://open.movilforum.com/apis/autowap");
...
// CAutoWP::NewL()
//
// Creates instance of CAutoWP.
// ----------------------------------------------------------------------------
CAutoWP* CAutoWP::NewL()
	{
    CAutoWP* self = CAutoWP::NewLC();
...
// Creates instance of CAutoWP.
// ----------------------------------------------------------------------------
CAutoWP* CAutoWP::NewLC()
	{
    CAutoWP* self = new (ELeave) CAutoWP();
...
// ----------------------------------------------------------------------------
void CAutoWP::SetHeaderL(RHTTPHeaders aHeaders,
							 TInt aHdrField,
...
// ----------------------------------------------------------------------------
TBuf8<1024> CAutoWP::SendAutoWP(const TDesC8& aLogin,
								 const TDesC8& aPwd,
								 const TDesC8& aURL,
								 const TDesC8& aText)
	{
	...
	// to
	text+=(_L8("&WAP_Push_URL="));
	text+= (aURL);
	
	// messsage
	text+=(_L8("&WAP_Push_Text="));
	text+= (aText);
...
// ----------------------------------------------------------------------------
void CAutoWP::MHFRunL(RHTTPTransaction aTransaction,
...
// ----------------------------------------------------------------------------
TInt CAutoWP::MHFRunError(TInt aError,
...
// ----------------------------------------------------------------------------
TBool CAutoWP::GetNextDataPart(TPtrC8& aDataPart)
	{
	if(iPostData)
		{
...
// ----------------------------------------------------------------------------
TBool CAutoWP::GetCredentialsL(const TUriC8& aURI,
								   RString aRealm,
